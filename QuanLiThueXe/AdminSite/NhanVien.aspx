<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSite/AdminSite.Master" AutoEventWireup="true" CodeBehind="NhanVien.aspx.cs" Inherits="QuanLiThueXe.AdminSite.NhanVien" %>
                                    ...
                                    <div class="card-body card-block">
                                          <asp:Panel ID="Panel1" runat="server">
											...
											<div class="form-group">
												...
												<asp:Button runat="server"  CssClass="btn btn-info" ID="them" Text="Thêm" />
                  
									<asp:Button runat="server" Visible="false" CssClass="btn btn-info" ID="Button1" Text="Cập Nhật" />
										<asp:Button runat="server"  CssClass="btn btn-danger" ID="Button4" Text="Xóa" />
                    </asp:Panel>
                                        ...
                                        <asp:Panel ID="Panel2" Visible="false" runat="server">
                                            ...
                                            <h6>không?</h6>
                                            									<asp:Button runat="server"  CssClass="btn btn-danger" ID="Button2" Text="Xóa" />
									<asp:Button runat="server"  CssClass="btn btn-info" ID="Button3" Text="Hủy" />
